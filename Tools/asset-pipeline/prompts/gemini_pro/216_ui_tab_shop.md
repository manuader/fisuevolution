...
Tab Tienda is the bottom-bar tab icon of the in-app-purchase STORE screen for Fisura Evolution, an Argentine merge-idle mobile game. Design it as a SHOPPING BAG seen from the front: a wide trapezoid body, slightly narrower at the top than at the bottom, filled sunny yellow #FFD93D with a thick ink #2C2C2C outline, and two thick ink handle loops arcing up from the top edge with a clear open hole inside each loop. A horizontal ink seam runs just below the top edge to mark the folded rim, and a cream #FFF8E7 vertical band down the centre of the bag carries a bold pink-red #FF4D6D five-point star, so the face of the bag is never one flat plane. Chunky and stable, standing flat, centered.
