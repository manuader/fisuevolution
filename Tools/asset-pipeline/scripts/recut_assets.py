...
RECORTE_VIEJO_A_PEDIDO = frozenset({
    ...
    "deidad",
    "director__directorio",
    "dueno_luna",
    "dueno_luna__selenita",
    "dueno_marte__terraformador",
    "dueno_pyme",
    "dueno_pyme__industrial",
    "emperador_cosmico",
    "emperador_cosmico__dinastia",
    "estanciero_estelar",
    "fast_food",
    "fondo_buitre__holdout",
    "junior_doctor__guardia",
    "limpiavidrios",
    "limpiavidrios__malabarista",
    "magnate_petrolero",
    "magnate_petrolero__esquisto",
    "magnate_solar",
    ...
    "semidios__titan",
    "senior_architect",
    "senior_architect__starchitect",
    "senior_doctor__cirujano",
    "senior_lawyer",
    "senior_lawyer__penalista",
    "senior_programmer__open_source",
    "senor_galaxia__agujero_negro",
    "ser_ascendido__iluminado",
    "trapito",
    "trillonario",
    "trillonario__moneda_propia",
})
